...
export async function use(namespace) {
    ...
    // Vendor\Jquery-Framework\src\Controllers\Controller -> vendor/Jquery-Framework/src/Controllers/Controller.js
    ...
    try {
        ...
        if (fileResponse.ok) {
            ...
            const namespaceHelperPath = getPath('vendor', 'Jquery-Framework/src/js/namespaceHelper.js');
